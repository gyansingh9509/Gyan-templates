  ...
  return (
    <footer>
      <section aria-label="Site Footer" className=" bg-gray-900 text-white flex flex-col md:flex-row py-3 justify-center items-center">
          ...
          <Link className='flex flex-row items-center md:ml-3 bg-white rounded-lg px-2 py-1 w-auto hover:scale-110 transition-all duration-500' target='_blank' href="https://github.com/gyansingh9509/gyan-ecommerce.git">
    ...
    <section aria-label="Site Footer" className=" bg-gray-900 text-white">
        <div className="max-w-screen-xl px-4 py-16 mx-auto space-y-8 sm:px-6 lg:space-y-16 lg:px-8">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
            <div>
              <div className="text-teal-600">
                <img src='/images/logo-min.png' className='w-40' alt='Gyansingh logo'/>
              </div>
              ...
              <ul className="flex gap-6 mt-8">
                <li>
                  <Link href="https://www.facebook.com/profile.php?" rel="noreferrer" target="_blank" className="transition hover:opacity-75">
                ...
                <li>
                  <Link href="https://instagram.com/gyansingh9509" rel="noreferrer" target="_blank" className="transition hover:opacity-75">
                ...
                <li>
                  <Link href="https://twitter.com/@Guanjatt" rel="noreferrer" target="_blank" className="transition hover:opacity-75">
                ...
                <li>
                  <Link href="https://github.com/gyansingh9509" rel="noreferrer" target="_blank" className="transition hover:opacity-75">
                ...
                <li>
                  <Link href="https://www.youtube.com/@DSMAGYANsingh" rel="noreferrer" target="_blank" className=" transition hover:opacity-75">
          ...
          <p className="text-xs text-gray-500">
            NextJS template created with ❤️ by <Link href="https://gyans-resume-builder.netlify.app/" className="text-gray-500 transition hover:opacity-75">Gyan Singh & creat your resume</Link>
          </p>
        </div>
      </section>
    </footer>
